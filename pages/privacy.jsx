export default function Privacy() {
    ...
    return (
        <div>
            ...
            <p className="text-sm text-white/30 mb-4">Son Güncelleme: 01/10/2024 🆕️</p>
  <div className="animateHeader text-white text-opacity-40 mt-5">
        <p>⊳ Botun Sorunsuz Çalışabilmesi İçin Yönetici Yektisi Verip Entegraston Rolünü En Üste Taşımanız Gerekir. <a className="text-white">(Svex Bot Geliştirici Ekibi olarak, kişisel verilerinizin gizliliğini ve güvenliğini korumak bizim için çok önemlidir. Bu nedenle, Discord sunucularımızı ziyaret ettiğinizde veya Svex'i kullandığınızda elde ettiğimiz kişisel verilerinizi nasıl topladığımızı, kullandığımızı ve paylaştığımızı açıklayan bu Gizlilik Politikasını hazırladık.
Bu Gizlilik Politikası, geliştirici ekibimiz tarafından sunulan Svex Discord botunu kullanan tüm kullanıcılar için geçerlidir.)</a></p>
